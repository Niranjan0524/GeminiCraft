...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const averageMessages = totalChats ? (totalMessages / totalChats).toFixed(1) : 0;
    const lastChat = chats[0]?.startTime ? new Date(chats[0].startTime).toLocaleDateString() : 'Never';
        ...
        <div className={`${
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="text-2xl font-bold mt-2">{stats.averageMessagesPerChat}</h2>
            </div>
